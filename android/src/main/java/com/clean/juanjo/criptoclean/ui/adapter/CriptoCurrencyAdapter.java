...
public class CriptoCurrencyAdapter extends RecyclerView.Adapter<CriptoCurrencyAdapter.CriptoViewHolder> {
    private List<Cripto> list;

    public CriptoCurrencyAdapter() {
        list = new ArrayList<>();
    }

    @Override
    public CriptoCurrencyAdapter.CriptoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_row_crypto, parent,
                false);
    ...
    @Override
    public void onBindViewHolder(CriptoCurrencyAdapter.CriptoViewHolder criptoViewHolder, int position) {
